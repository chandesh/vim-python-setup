    ...
    agents = [
        {
            ...
            "logo_url": "https://cdn.openai.com/chatgpt/images/chatgpt-share-og.png",
        ...
        },
        {
            ...
            "logo_url": "https://www.anthropic.com/_next/static/media/claude-logo.6e41b48f.svg",
            "category_id": productivity_cat.id if productivity_cat else None,
            "pricing_model": PricingModel.FREEMIUM,
            "featured": True,
            "tags": [conv_tag] if conv_tag else []
        },
        {
            ...
            "logo_url": "https://github.githubassets.com/assets/github-copilot-icon.png",
...
def seed_extended_mcp_servers(db: Session, categories, tags):
    ...
    servers = [
        ...
        },
        {
            ...
            "logo_url": "https://avatars.githubusercontent.com/u/51025925",
            "language": "Python",
            "scope": ServerScope.LOCAL,
        ...
        },
        {
            ...
            "logo_url": "https://github.githubassets.com/assets/GitHub-Mark.png",
            "language": "Go",
        ...
        },
        {
            ...
            "logo_url": "https://avatars.githubusercontent.com/u/183546725",
            "language": "TypeScript",
            "scope": ServerScope.LOCAL,
            "category_id": dev_cat.id if dev_cat else None,
